      ...
      <div className="bg-[var(--color-stone)] py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-[var(--color-text-light)]">
            ...
            <span className="mx-2">/</span>
            <span className="text-[var(--color-text)]">Amersham</span>
          </nav>
        </div>
      </div>
      ...
      <section className="py-24 bg-[var(--color-off-white)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              <h3 className="text-xl font-medium text-[var(--color-text)] mb-6">Areas we serve in Amersham:</h3>
              <div className="bg-[var(--color-stone)] border border-[var(--color-border)] p-6 mb-6">
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="w-5 h-5 text-[var(--color-bronze)]" />
                  <span className="font-medium text-[var(--color-text)]">Postcodes: HP6, HP7</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="bg-[var(--color-off-white)] p-6 border border-[var(--color-border)]">
                <h3 className="text-xl font-medium text-[var(--color-text)] mb-2">{item.title}</h3>
