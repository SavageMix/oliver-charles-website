      ...
      <div className="bg-[#f5f0e6] py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-[#666666]">
            ...
            <span className="mx-2">/</span>
            <span className="text-[#2c2c2c]">Beaconsfield</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[#c9b896]">6 miles from our base</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Landscaping Services in <span className="text-[#c9b896]">Beaconsfield</span>
            </h1>
            <p className="text-xl text-gray-300">
              Creating beautiful outdoor spaces for Beaconsfield homeowners. 
              From modern estates in New Town to period properties in Old Town.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="bg-[#f5f0e6] p-6 rounded-xl mb-6">
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="w-5 h-5 text-[#c9b896]" />
                  <span className="font-bold text-[#2c2c2c]">Postcode: HP9</span>
                </div>
                <ul className="space-y-2">
                  {["Old Town", "New Town", "Holtspur", "Ledborough", "Butlers Cross"].map((area) => (
      ...
      <section className="py-16 bg-[#2c2c2c]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Get Your Free Beaconsfield Quote
          </h2>
          <p className="text-gray-300 mb-8">
            Contact us today for a free site survey and detailed quote in Beaconsfield.
          </p>
