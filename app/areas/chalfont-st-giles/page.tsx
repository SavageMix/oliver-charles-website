      ...
      <div className="bg-[#f5f0e6] py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-[#666666]">
            ...
            <span className="mx-2">/</span>
            <span className="text-[#2c2c2c]">Chalfont St Giles</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[#c9b896]">4 miles from our base</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Landscaping Services in <span className="text-[#c9b896]">Chalfont St Giles</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="bg-[#f5f0e6] p-6 rounded-xl mb-6">
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="w-5 h-5 text-[#c9b896]" />
                  <span className="font-bold text-[#2c2c2c]">Postcode: HP8</span>
                </div>
