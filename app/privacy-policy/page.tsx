        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12 bg-[var(--color-stone)] p-8 border border-[var(--color-border)]">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4 flex items-center gap-3">
                <Eye className="w-6 h-6 text-[var(--color-bronze)]" />
                Information We Collect
              </h2>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4 flex items-center gap-3">
                <Lock className="w-6 h-6 text-[var(--color-bronze)]" />
                How We Use Your Information
              </h2>
              <p className="text-[var(--color-text-light)] mb-4">
            ...
            {/* Your Rights */}
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4">Your Rights</h2>
              <p className="text-[var(--color-text-light)] mb-4">
            ...
            <div className="mb-12 bg-[var(--color-forest)] p-8 text-white">
              ...
              <div className="space-y-3">
                <a href="tel:+447837666766" className="flex items-center gap-3 text-[var(--color-bronze)] hover:underline">
                  <Phone className="w-5 h-5" />
                  +44 7837 666766
                </a>
                <a href="mailto:info@ocgardendesign.co.uk" className="flex items-center gap-3 text-[var(--color-bronze)] hover:underline">
