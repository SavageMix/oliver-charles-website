...
import { MapPin, Calendar, Ruler, ArrowRight, X, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <main className="min-h-screen">
      ...
      <section className="py-24 bg-[#f5f0e6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Projects Grid */}
          <div ref={gridRef} key={selectedCategory} className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
