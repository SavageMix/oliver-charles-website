...
const projects = [
  ...
  },
  {
    ...
    date: 'February 2024',
    size: '75m²',
    description: 'A total garden refurbishment featuring composite decking area alongside a porcelain patio and glass balustrade.',
    ...
    testimonial: {
      quote: "We couldn't be happier with our new garden. The composite decking area is perfect for entertaining.",
      author: "Hannah",
      location: "Bourne End"
    }
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Premium composite decking solutions that combine the natural beauty of wood with 
              zero maintenance requirements. Perfect for Amersham, Chesham & Beaconsfield gardens.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-[#666666] text-lg mb-8">
                Enjoy the natural warmth of timber without any of the maintenance headaches. 
                Our composite decking is engineered to withstand the British weather year after year.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-[#666666]">
              Browse our recent composite decking installations across Buckinghamshire.
            </p>
          </div>
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                  <Image
                    ...
                    alt={`${project.title} - Composite decking installation in ${project.location}`}
                    fill
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-8">
            ...
            <p className="text-[#666666]">
              We install composite decking throughout Buckinghamshire and surrounding areas.
            </p>
          </div>
