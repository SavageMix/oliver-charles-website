...
const projects = [
  ...
  },
  {
    ...
    date: 'February 2024',
    size: '75m²',
    description: 'A total garden refurbishment featuring a retaining wall with glass balustrade, providing safety while maintaining an open feel.',
    ...
    testimonial: {
      quote: "The glass balustrade on the retaining wall looks amazing! It provides safety while keeping the garden feeling open.",
      author: "Hannah",
      location: "Bourne End"
    }
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Elegant glass balustrades that provide safety without sacrificing views. 
              Perfect for balconies, terraces, and garden levels in Amersham, Chesham & Beaconsfield.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[#666666] text-lg mb-8">
                Create stunning visual impact with our premium glass balustrade systems. 
                Whether for a balcony, terrace, or garden retaining wall, glass provides 
                unobstructed views while meeting all safety requirements.
              </p>
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                  <Image
                    ...
                    alt={`${project.title} - Glass balustrade installation in ${project.location}`}
                    fill
