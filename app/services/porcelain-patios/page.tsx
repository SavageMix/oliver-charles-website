...
const projects = [
  ...
  },
  {
    ...
    testimonial: {
      quote: "The team have done a fantastic job on our patio. From start to finish they have been professional and hardworking.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Premium porcelain patio specialists serving Amersham, Chesham, Beaconsfield and surrounding areas. 
              Frost-resistant, slip-proof, and built to last with our 5-year guarantee.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[#666666] text-lg mb-8">
                Transform your garden with stunning porcelain patio installations. Our premium 
                porcelain paving offers timeless beauty with minimal maintenance requirements.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Amersham', 'Chesham', 'Beaconsfield', 'Chalfont St Giles', 'Little Chalfont', 'Great Missenden', 'High Wycombe', 'Bovingdon', 'Holmer Green'].map((area) => (
