      ...
      <div className="bg-[var(--color-stone)] py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-[var(--color-text-light)]">
            ...
            <span className="text-[var(--color-text)]">Terms of Service</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <div className="flex justify-center mb-6">
              <Scale className="w-16 h-16 text-[var(--color-bronze)]" />
            </div>
            <h1 className="text-4xl md:text-5xl font-serif font-medium mb-6">Terms of Service</h1>
            <p className="text-xl text-white/70">
              Please read these terms carefully before using our website and services.
            </p>
            <p className="text-[var(--color-bronze)] mt-4 text-sm">Last updated: March 2025</p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4 flex items-center gap-3">
                <FileText className="w-6 h-6 text-[var(--color-bronze)]" />
                Agreement to Terms
              </h2>
            ...
            <div className="mb-12 bg-[var(--color-stone)] p-8 border border-[var(--color-border)]">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4 flex items-center gap-3">
                <Gavel className="w-6 h-6 text-[var(--color-bronze)]" />
                Intellectual Property Rights
              </h2>
              <p className="text-[var(--color-text-light)] leading-relaxed">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4 flex items-center gap-3">
                <AlertCircle className="w-6 h-6 text-[var(--color-bronze)]" />
                User Representations
              </h2>
            ...
            {/* Services */}
            <div className="mb-12 bg-[var(--color-stone)] p-8 border border-[var(--color-border)]">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4">Our Services</h2>
              <p className="text-[var(--color-text-light)] mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4 flex items-center gap-3">
                <PoundSterling className="w-6 h-6 text-[var(--color-bronze)]" />
                Quotations and Pricing
              </h2>
              <ul className="space-y-3 text-[var(--color-text-light)]">
                <li className="flex items-start gap-3">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4 flex items-center gap-3">
                <Clock className="w-6 h-6 text-[var(--color-bronze)]" />
            ...
            <div className="mb-12 bg-[var(--color-stone)] p-8 border border-[var(--color-border)]">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4">Limitation of Liability</h2>
              <p className="text-[var(--color-text-light)] leading-relaxed">
            ...
            {/* Governing Law */}
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4">Governing Law</h2>
              <p className="text-[var(--color-text-light)] leading-relaxed">
            ...
            {/* Changes to Terms */}
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-medium text-[var(--color-text)] mb-4">Changes to These Terms</h2>
              <p className="text-[var(--color-text-light)] leading-relaxed">
